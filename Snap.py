class Card:
    def __init__(self, name, cost, power, action):
        self.name = name
        self.cost = cost
        self.power = power
        self.action = action

NICO= Card("Nico M",1,2, SAVE ME!!!)
CARNAGE = Card("Carnage",2,2,)
def Cdestroy(): 
MAGIK = Card("Magik",3,2,"add 1 turncount")
def Turn7(): TURNCOUNT=7
VENOM = Card("Venom",3,3,"destroy")
def Vdestroy(): 
...
L2 = []
L3 = []
#need to make power check on cards
TURN = 1
TURNCOUNT = 6
HAND = []
...
#make sure you account for stick shenanigans
